...
> **every hash stored before this release is now invalid**: the first
> `compare-fingerprints --source-hash <old-hash>` run will report a false
> mismatch. Re-generate and re-store baseline fingerprints after upgrading.
>
